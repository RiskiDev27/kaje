...
CMD:reply(playerid, params[])
{
    ...
    if (isnull(params))
        return Usage(playerid, "/reply [report id] (/reports for a list)");
...
CMD:reports(playerid, params[])
{
    ...
    for (new i = 0; i != MAX_REPORTS; i++)
    {
        ...
        ShowPlayerDialog(playerid, DIALOG_REPORTS, DIALOG_STYLE_TABLIST_HEADERS, "REPORT", gstr, "Next", "Cancell");
    }
    return 1;
}
